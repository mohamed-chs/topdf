...
## Phase 4: Quality of Life & Polish (Completed)
...
- [x] Advanced Headers/Footers (Puppeteer native support).
- [x] Improved Image Handling (Local path resolution).
- [x] Configuration file support (.topdfrc).
